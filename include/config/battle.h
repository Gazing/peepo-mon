...
#define B_AFFECTION_MECHANICS           FALSE      // In Gen6+, there's a stat called affection that can trigger different effects in battle. From LGPE onwards, those effects use friendship instead. DISABLED: friendship-based affection gave +2 crit stages (=50% crits) to every max-friendship mon, making crits feel constant/unfair in our shared game (also removes survive-KO-with-1HP, dodge, status shrug-off, exp perks).
